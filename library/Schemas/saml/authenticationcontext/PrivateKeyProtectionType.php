...
/**
 * Class representing PrivateKeyProtectionType
 *
 * 
 * XSD Type: PrivateKeyProtectionType
 */
class PrivateKeyProtectionType
{
    ...
    /**
     * @property \BankId\Merchant\Library\Schemas\saml\authenticationcontext\KeySharing
     * $keySharing
     */
    private $keySharing = null;
     ...
     * Gets as keySharing
     *
     * @return \BankId\Merchant\Library\Schemas\saml\authenticationcontext\KeySharing
     */
    public function getKeySharing()
    {
        return $this->keySharing;
    }

    /**
     * Sets a new keySharing
     *
     * @param \BankId\Merchant\Library\Schemas\saml\authenticationcontext\KeySharing
     * $keySharing
     * @return self
     */
    public function setKeySharing(\BankId\Merchant\Library\Schemas\saml\authenticationcontext\KeySharing $keySharing)
    {
